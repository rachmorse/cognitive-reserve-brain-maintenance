...
Figure 5 depicts how the hippocampal volume–memory increases as anterior Salience Network connectivity decreases, demonstrating a significant positive relationship between memory and hippocampal volume only for participants with anterior SN connectivity less than 0.09SD above the mean. Figure 6 shows the difference in anterior SN connectivity when comparing low versus high CR groups. All functional connectivity results are summarized in Tables 5 and 6.
...
Difference in anterior SN connectivity with participants aging CR-like divided into high CR and low CR groups for visualization. For each region, connectivity was averaged across timepoints, scaled, and averaged by group. The influence of MRI scanner/cohort was removed using residuals, and the resulting low CR anterior SN connectivity values were subtracted from the high CR values. High CR participants had higher anterior SN connectivity in all regions. Abbreviations: CR Cognitive Reserve, SN Salience Network.     
