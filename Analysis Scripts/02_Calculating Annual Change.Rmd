...
# Step 1. Calculate Mean ICV by study and timepoint (e.g. Cobra gets a mean ICV for each timepoint)
...
merg_filt <- merged_cohorts %>%
  filter(cohort == "Cobra") %>%
  select(id, memory_slopes, hc_slopes, dmn_slopes)
