...
Difference in anterior Salience Network connectivity for high CR and low CR participants among those aging CR-like. Each region’s connectivity was averaged across all timepoints and z-scored before calculating an average for each group. The influence of MRI scanner/cohort was removed using residuals. Abbreviations: CR Cognitive Reserve.  
