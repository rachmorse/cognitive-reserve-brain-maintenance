...
Difference in anterior Salience Network connectivity for high CR and low CR participants among those aging CR-like. Each region’s connectivity was averaged across all timepoints per participant and z-scored before calculating an average for each group. Abbreviations: CR Cognitive Reserve.   
