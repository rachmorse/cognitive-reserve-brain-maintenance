...
We then classified participants as aging CR-like (N = `r cr_pathway`/`r total_participants`) or BM-like (N = `r bm_pathway`/`r total_participants`) (Figure 4). The mean BM amount for participants aging BM-like was  `r round(mean_bm, 3)` (range = `r round(min_bm, 3)` - `r round(max_bm, 3)`), and the mean CR amount for participants aging CR-like was `r round(mean_cr, 3)` (range = `r round(min_cr, 3)` - `r round(max_cr, 3)`).
...
#   annotate("text", x = -1.5, y = 1.9, label = "Participants Aging CR-like", color = "black", size = 4, hjust = 0.5) +
#   annotate("text", x = 1.5, y = 1.9, label = "Participants Aging BM-like", color = "black", size = 4, hjust = 0.5) +
...
A figure depicting participants as aging either BM-like or CR-like. The x-axis represents the total amount of CR for participants aging CR-like and the total amount of BM for participants aging BM-like. The y-axis represents the density of participants.
