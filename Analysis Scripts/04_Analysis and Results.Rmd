...
######################
# Take a look at the plot and think about what it means for high CR to be significant too 
######################
# Fit the model 
model <- lmer(scale(memory) ~ scale(reverse_cr) * scale(adj_HIP_total) + (1|id) + 
